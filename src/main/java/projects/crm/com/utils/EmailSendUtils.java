...
import projects.crm.com.mail.SendMailSSLWithAttachment;
import static projects.crm.com.constants.FrameworkConstants.REPORT_TITLE;
...
public class EmailSendUtils {
    ...
    public static void sendEmail(int count_totalTCs, int count_passedTCs, int count_failedTCs, int count_skippedTCs) {
            ...
            String port = "587";
            String mailFrom = "kingkukk15@gmail.com";
            String password = "hevnmnclncqaabwy";

            // message info
            String mailTo = "khaikietxuan@gmail.com";
            ...
            try {
                SendMailSSLWithAttachment.sendEmailWithAttachments(host, port, mailFrom, password, mailTo,
                        subject, messageBody, attachFiles);
